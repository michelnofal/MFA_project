...
file_handle <- "D3_timecourse1_no12or20"
...
growth.dat <- growth.dat %>% filter(time.pt %in% c(0,16,24))
intra.dat <- intra.dat %>% filter(time.pt %in% c(0,16,24))
...
D3_1_fluxes_no12or20 <- fluxes.list$fluxes
D3_1_fluxes_no12or20$data = "BMK_D3_1_no12or20"
# save(D3_1_fluxes_no12or20, file="D3_1_fluxes_no12or20.Rda")
