...
file_handle <- "KRPCU_timecourse1"

# import growth data
growth.dat <- read.table("first_timecourses/PCV_timecourse_1.csv", header=TRUE, sep=",")
# import intracellular data
intra.dat <- read.table("first_timecourses/krpcu_timecourse1_intracellular.csv", header=TRUE, sep=",")
# import extracellular data
extra.dat <- read.table("first_timecourses/krpcu_timecourse1_extracellular.csv", header=TRUE, sep=",")
...
aa_table <- data.table(compound = c("lysine","threonine","tyrosine"), DMEM.conc = c(800,800,500)/1.06)
...
KRPCU_timecourse1_fluxes <- fluxes.list$fluxes
# save(KRPCU_timecourse1_fluxes, file="KRPCU_timecourse1_fluxes.Rda")
